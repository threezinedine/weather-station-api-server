...
class UserControllerTest(unittest.TestCase):
    ...
    def createAnUser(self):
        self.user_controller.create_new_user(username=FIRST_TEST_USER_USERNAME, password=FIRST_TEST_USER_PASSWORD)

    def createTwoUsers(self):
        self.createAnUser()
        self.user_controller.create_new_user(username=SECOND_TEST_USER_USERNAME, password=SECOND_TEST_USER_PASSWORD)
